...
@v0_blueprint.route('/docs')
@cross_origin()
def swagger_ui():
    return redirect('/apidocs/') 


@v0_blueprint.route("/", methods=["GET"])
@cross_origin()
def welcome():
    """ACCUEIL"""
...
@v0_blueprint.route('/register', methods=['POST'])
@cross_origin()
def register():
    """
...
@v0_blueprint.route('/login', methods=['POST'])
@cross_origin()
def login():
    """
...
@v0_blueprint.route('/set_localisation', methods=['POST'])
@cross_origin()
...
@v0_blueprint.route('/get_localisation', methods=['GET'])
@cross_origin()
...
@v0_blueprint.route('/set_routes', methods=['POST'])
@cross_origin()
def set_routes():
    """
...
@v0_blueprint.route('/get_users', methods=['GET'])
@cross_origin()
def get_users():
    """
...
@v0_blueprint.route('/get_routes', methods=['GET'])
@cross_origin()
def get_routes():
    """
...
@v0_blueprint.route('/set_travel', methods=['POST'])
@cross_origin()
def set_travel():
    """
...
@v0_blueprint.route('/get_travel', methods=['GET'])
@cross_origin()
def get_travel():
    """
...
# @v0_blueprint.route("/assign_driver", methods=["POST"])
# def assign_driver():
...
# @v0_blueprint.route("/top_customers/<driver_username>/<int:n>", methods=["GET"])
...
# @v0_blueprint.route('/cost', methods=['POST'])
# def cost():
#     data = request.get_json()
